...
Simply speaking, the reason is that the solution set of IP is the subset of the solution set of LP relataxtion (fractional numbers include integral numbers), so LP relataxtion can achieve better optimization.
...
> The proof of this lemma is in the [end](#lemma-proof) of this article.
{: .prompt-tip }
