...
In this note, let's quickly go through all the distinguished papers to see what have they done in their field.


## Distinguished Papers

Papers are sorted in alphabetical order.
...
This is a classical PL paper about compiler design and implementation. This kind of solid work requires large amount of effort and undoubtedly deserves a distinguished award. It is hard to believe that Joel Kuepper, as a freshman in the research field, could lead such a complicated task and put everything nicely to the ground. Awesome!
...
Ende Jin is a master student at University of Waterloo under the guidence of [Yizhou Zhang](https://cs.uwaterloo.ca/~yizhou/). Their group aim to design and implement programming languages with rich expressive power, strong guarantees, and efficient implementations. Ende Jin has graduated in 2023 summer and this is the only paper he has published.
...
**Author:** [Manya Bansal](https://manya-bansal.github.io/), Olivia Hsu, Kunle Olukotun, Fredrik Kjolstad

[[pdf]]({{ site.url }}/download/PLDI23/mosaic.pdf)

Manya Bansal is currently a Ph.D. student at MIT advised by [Saman Amarasinghe](https://groups.csail.mit.edu/commit/) and [Jonathan Ragan-Kelley](https://people.csail.mit.edu/jrk/). This one is the first and only paper published by her.
...
**Author:** [Kiran Gopinathan](https://gopiandcode.uk/), Mayank Keoliya, Ilya Sergey

[[pdf]]({{ site.url }}/download/PLDI23/auto_proof_repair.pdf)

Kiran Gopinathan is the fifth year Ph.D. student at National University of Singapore advised by [Ilya Sergey](https://ilyasergey.net/). This is his first paper during the Ph.D. career. Their group is currently focusing on automated program repair via static analysis and verification.

In this paper, they present the first proof repair methodology for higher-order imperative functions, whose initial versions were verified in the Coq proof assistant and whose specifications remained unchanged. Our proof repair procedure is based on the combination of dynamic program alignment, enumerative invariant synthesis, and a novel technique for efficiently pruning the space of invariant candidates, dubbed proof-driven testing, enabled by the constructive nature of Coq’s proof certificates.
...
**Author:** [Jingbo Wang](https://viterbi-web.usc.edu/~jingbow/), Aarti Gupta, Chao Wang

[[pdf]]({{ site.url }}/download/PLDI23/MILP_constraints.pdf)

Jingbo Wang is an incredibly productive student working with professor [Chao Wang](https://sites.usc.edu/chaowang/) at University of Southern California. And she will join Purdue university as an assistant professor this fall. Most of her works focus on program synthesis.

> **Program synthesis** is the task to construct a program that provably satisfies a given high-level formal specification. In contrast to program verification, the program is to be constructed rather than given.
{: .prompt-tip}
...
> For basic backgound of integer and linear programmming, you can read my blog [Randomized Algorithm IV— Integer Programming]({{ site.url }}/posts/RandAlg4/).
{: .prompt-tip}

They implemented and evaluated the method on a wide range of benchmark specifications from statistics, machine learning, and data science applications. The results show that the quality of the synthesized MILP constraints is even better than manually-written constraints.


### 8. Trace-Guided Inductive Synthesis of Recursive Functional Programs

**Author:** [Yongwei Yuan](https://victoryyw.github.io/), Arjun Radhakrishna, Roopsha Samanta
