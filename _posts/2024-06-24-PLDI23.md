...
PLDI (Conference on Programming Language Design and Implementation) 2023, as the most famous conference in the programming language theory field, was held at Orlando, Florida in June. 

This conference accepted 83 papers, and 8 were awarded as distinguished papers. Among them, 2 are about verification, 3 are about compilers, 1 is about proof repair, and 2 are about synthesis. In terms of the geographic location of the first author's school, most of the distinguished papers were from North America, except one from Taiwan and one from Singapore.

In this note, let's quickly go through all the distinguished papers to see what have they achieved in their field.
