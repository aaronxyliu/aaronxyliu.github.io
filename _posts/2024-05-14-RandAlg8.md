...
description: "Why does choosing the better of two random bins transform load balancing? Explore the balls-into-bins model and its surprising impact on hashing."
math: true
