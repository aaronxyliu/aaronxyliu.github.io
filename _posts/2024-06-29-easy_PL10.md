...
description: "Move from functional models to imperative programs by formalizing locations, stores, expression evaluation, commands, and the operational semantics of While."
math: true
