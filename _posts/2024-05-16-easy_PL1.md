...
description: "Begin programming language theory with model languages, lambda notation, scope, reduction, and three complementary ways to explain what programs mean."
math: true
