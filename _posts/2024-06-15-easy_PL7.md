...
description: "Develop the simply typed lambda calculus from types and contexts to products and sums, with the syntax and lemmas needed for rigorous reasoning."
math: true
