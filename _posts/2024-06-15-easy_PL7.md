...
Using these notations, the natural deduction proofs and their consequences are defined as follows:
...
A formula $\tau$ is **provable** if there is a proof $M$ with $\empty \vdash_M \sigma$.
