...
description: "Learn to turn expectations into high-probability guarantees with Markov, Chebyshev, and Chernoff bounds, then apply them to robust mean estimation."
math: true
