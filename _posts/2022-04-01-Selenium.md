...
description: "Selenium 究竟怎样控制浏览器？从 WebDriver 协议一路走进源码，拆解自动化测试命令背后的完整调用链。"
...
![WebDriver、浏览器驱动与浏览器之间的通信关系]({{ site.url }}/assets/img/2022-04-05/WebDriver-W3C-Protocol.png)
