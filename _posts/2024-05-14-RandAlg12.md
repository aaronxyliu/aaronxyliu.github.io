...
description: "Make predictions without knowing the future by combining expert advice, from the halving algorithm to weighted majority and bounded cumulative mistakes."
math: true
