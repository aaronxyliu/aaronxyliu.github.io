...
& \leq \sum_{l=1}^{\inf} \Pr(\exists \text{ cycle of length } l \text{ in } G)\\
& \leq \sum_{l=1}^{\inf} n^l \cdot m^l \cdot (\frac{2}{n^2})^l\\
& \leq \sum_{l=1}^{\inf} (\frac{2m}{n})^l\\
& \leq \sum_{l=1}^{\inf} (\frac{1}{3})^l = \frac{1}{2}.
\end{split}
$$
...
$$
\begin{split}
\Pr(i \text{ and } j \text{ are connected}) &\leq \sum_{l=1}^{\inf} \Pr(\exists \text{ path from } i \text{ to } j \text{ of length }l)\\
& \leq \sum_{l=1}^{\inf} n^{l-1} \cdot m^l \cdot (\frac{2}{n^2})^l\\
& \leq \frac{1}{n} \sum_{l=1}^{\inf} (\frac{2m}{n})^l\\
& \leq \frac{1}{2n}.
\end{split}
$$
