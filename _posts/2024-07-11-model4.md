...
$$\frac{\phantom{\stackrel{\text{def}}{=}}\Gamma \: \triangleright \: M = N : \sigma}{\Gamma \: \triangleright \: M \leq N : \sigma} \tag*{($eq$)}$$
...
if we take $$[c/x]A \:\equiv \:\Gamma \: \triangleright \: c \leq N:\sigma$$ as an additional hyphthesis.
