...
description: "Turn domain theory into a working semantics for PCF, using factorial, multiple fixed points, and fixed-point induction to reason about recursive programs."
math: true
