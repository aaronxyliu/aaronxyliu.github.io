...
description: "Can randomness make an algorithm more reliable? Start with fast matrix multiplication verification and build intuition for probabilistic correctness and repetition."
math: true
