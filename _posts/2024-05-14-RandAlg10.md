...
description: "Approximate a difficult DNF counting problem with Monte Carlo sampling, then refine the estimator to obtain a practical probabilistic algorithm."
math: true
